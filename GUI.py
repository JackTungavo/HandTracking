...
class mainClass:
    def __init__(self,master):
        ...
        self.infoButton = tk.Button(master, text = "Info", command = self.infoWindow, height = 5, width = 25, bg = "LIGHT BLUE")
...
class calibration:
    ...
    def stage3(self):
        ...
        self.instructions = tk.Label(self.master, text = "Is the blue box around your face, and green boxes around your eyes?")
...
class info():
    def __init__(self, master):
        ...
        self.calibrationInstructionsButton = tk.Button(self.master, text = "Calibration Instructions", height = 3, width = 40, bg = 'LIGHT BLUE', command = self.instructionsWindow)
